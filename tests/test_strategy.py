...
from simagora.engine.strategy import (
  ...
  ATRTrendFollowingStrategy, MeanReversionStrategy, RSIMeanReversionStrategy, MultiInstrumentStrategy,
...
class TestATRTrendFollowingStrategy(unittest.TestCase):
  ...
  - the Donchian breakout entry and close-opposite-direction mechanics
  are inherited unchanged from TrendFollowingBase and already covered
  in depth via TrendFollowingStrategy in TestTrendFollowingStrategy, so
